...
export const kogenFactoryQueries = {
  ...
  deployedOptions: <TData = DeployedOption>({
    client,
    args,
    options,
...
export interface KogenFactoryDeployedOptionsQuery<TData>
  extends KogenFactoryReactQuery<DeployedOption, TData> {
  args: {
    afterDateInSeconds?: number;
  };
}
export function useKogenFactoryDeployedOptionsQuery<TData = DeployedOption>({
  client,
  args,
  options,
}: KogenFactoryDeployedOptionsQuery<TData>) {
  return useQuery<DeployedOption, Error, TData>(
